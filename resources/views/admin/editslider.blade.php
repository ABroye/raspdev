                            ...
                            @method('PUT')
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description1" value="{{$slider->description1}}" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description2" value="{{$slider->description2}}" class="form-control"
                                            id="exampleInputEmail1" placeholder="Enter slider description" required>
                                    </div>
